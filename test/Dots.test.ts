...
describe("Dots.play", () => {
  ...
  it("ends in a draw when the top square count is tied", () => {
    ...
    dots.play([1, 0], [2, 0], BOB, T0);
    dots.play([0, 0], [1, 0], ALICE, T0);
    dots.play([2, 0], [2, 1], BOB, T0);
    dots.play([1, 0], [1, 1], ALICE, T0);
    expect(dots.play([1, 1], [2, 1], BOB, T0).squaresClosed).toBe(1); // closes sq1 -> BOB
    expect(dots.play([0, 1], [1, 1], ALICE, T0).squaresClosed).toBe(1); // closes sq0 -> ALICE
    dots.play([1, 1], [1, 2], BOB, T0);
    dots.play([0, 2], [1, 2], ALICE, T0);
    dots.play([1, 2], [2, 2], BOB, T0);
    expect(dots.play([0, 1], [0, 2], ALICE, T0).squaresClosed).toBe(1); // closes sq2 -> ALICE
    const closing = dots.play([2, 1], [2, 2], BOB, T0); // closes sq3 -> BOB, fills the grid
